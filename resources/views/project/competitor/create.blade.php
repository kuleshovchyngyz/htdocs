    ...
    <div class="content-wrapper container-fluid">
        <div class="row mt-5">
            <div class="col-lg-8 offset-md-2">
                <div class="card">
                    <div class="card-header"><h1>{{ __('Create Competitor') }}</h1></div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('project.competitor.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="numberofregions" name="numberofregions" value="{{ $items->count() }}">
                                        @foreach($items as $key => $region)

                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="{{ $region->region->id }}" name="region{{ $key }}" checked>
